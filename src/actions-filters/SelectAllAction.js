  ...
  render() {
    ...
    if (this.props.selectAll) {
      if (this.props.loading) {
        selectAll = (
          <a className="apilist-button apilist-button--link" href="#">
        ...
        selectAll = (
          <a className="apilist-button apilist-button--link" href="#" onClick={this.handleSelectAllClick}>
    ...
    if (this.props.numSelected > 0) {
      deselect = (
        <a className="apilist-button apilist-button--link" href="#" onClick={this.handleDeselectAllClick}>De-select all</a>
      )
    }
